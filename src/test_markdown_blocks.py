...
"""                
                ...
                self.assertEqual(
                html,
                "<div><blockquote>This is a block Quote This is another secondline with <i>italic</i> text and <code>code</code> here  This is a third line with a missing space  The line above is empty.</blockquote></div>",
                )
